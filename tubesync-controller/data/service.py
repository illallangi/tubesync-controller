...
@kopf.on.probe(
    id=data_service_idx.__name__,
)
async def data_service_probe(
    data_service_idx: kopf.Index,
    **_,
):
    return {
        namespace: {
            o["metadata"]["name"]: o for o in data_service_idx[namespace]
        }
        for namespace in data_service_idx
    }
