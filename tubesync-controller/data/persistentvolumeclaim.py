...
CONTROLLER="data-persistentvolumeclaim"
...
async def data_persistentvolumeclaim_idx(
    namespace,
    body,
    **_,
):
...
@kopf.on.probe(
    id=data_persistentvolumeclaim_idx.__name__,
)
async def data_persistentvolumeclaim_probe(
    data_persistentvolumeclaim_idx: kopf.Index,
    **_,
):
    return {
        namespace: {
            o["metadata"]["name"]: o
            for o in data_persistentvolumeclaim_idx[namespace]
        }
        for namespace in data_persistentvolumeclaim_idx
    }
...
async def data_persistentvolumeclaim(
    namespace,
    body,
    patch,
    **kwargs,
